    ...
    <div className="flex flex-col gap-s2">
      <div className="relative">
        <textarea
          ...
          className="block w-full resize-none rounded-bubble-l border border-surface-edge bg-bg-deep px-s4 py-s3 pr-s8 text-small text-paper placeholder:text-muted focus:border-lime/60 focus:outline-none focus:ring-1 focus:ring-lime/40 disabled:opacity-50"
        />
        <button
          type="button"
          onClick={submit}
          ...
          className="absolute right-s3 top-s3 inline-flex h-6 w-6 items-center justify-center rounded-pill text-lime transition-colors duration-fast hover:bg-lime/15 disabled:opacity-40"
        >
          {pending ? (
      ...
      <div className="flex items-center justify-between text-micro text-muted">
        <span>
          {confirmed ? (
            <span className="inline-flex items-center gap-s1 text-lime">
